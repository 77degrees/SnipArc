...
using SnipSnap.App.Recognition;
using SnipSnap.App.Recording;
using SnipSnap.App.Scrolling;
using SnipSnap.Windows.Capture;
using SnipSnap.Windows.Clipboard;
using SnipSnap.Windows.Displays;
using SnipSnap.Windows.Hotkeys;
using SnipSnap.Windows.Policies;
using SnipSnap.Windows.Startup;
using SnipSnap.Windows.Windowing;
...
internal sealed class AppController : IDisposable
{
    ...
    private readonly StartupRegistrationService _startup = new("SnipSnap");
    ...
    public AppController(Dispatcher dispatcher)
    {
        ...
        var parameters = new HwndSourceParameters("SnipSnap.MessageWindow")
        {
            Width = 0,
            Height = 0,
    ...
    private static void ShowAbout() => MessageBox.Show(
        ...
        "About SnipSnap", MessageBoxButton.OK, MessageBoxImage.Information);
    ...
    private void ShowError(string message, Exception ex)
    {
        ...
        {
            MessageBox.Show(_overlay, details, "SnipSnap", MessageBoxButton.OK, MessageBoxImage.Error);
            return;
        }

        MessageBox.Show(details, "SnipSnap", MessageBoxButton.OK, MessageBoxImage.Error);
    }
