...
using SnipSnap.Windows.Settings;

namespace SnipSnap.Windows.Tests.Settings;

public sealed class JsonSettingsStoreTests : IDisposable
{
    private readonly string _root = Path.Combine(Path.GetTempPath(), $"SnipSnap.Tests.{Guid.NewGuid():N}");
    ...
    private JsonSettingsStore<TestSettings> CreateStore(
        ...
        new("SnipSnap", "settings.json", 2, () => new TestSettings("Default", false), migrations, _root, jsonOptions);
